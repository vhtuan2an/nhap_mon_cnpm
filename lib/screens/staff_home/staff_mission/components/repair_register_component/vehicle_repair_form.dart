  ...
  class VehicleRepairForm extends StatefulWidget {
    const VehicleRepairForm({super.key});

    @override
    _VehicleRepairFormState createState() => _VehicleRepairFormState();
  }

  class _VehicleRepairFormState extends State<VehicleRepairForm> {
            ...
            ElevatedButton(
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  Navigator.pushNamed(context, CompleteRepairRegisterScreen.routeName);
                }
              },
